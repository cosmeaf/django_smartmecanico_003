...
class Vehicle(Base, models.Model):
    ...
    fuell = models.CharField('Combustível', max_length=255, blank=False, null=False)
    year = models.CharField('Ano Fabricação', max_length=4, blank=False, null=False)
    odomitter = models.CharField('Hodometro', max_length=9, blank=False, null=False)
