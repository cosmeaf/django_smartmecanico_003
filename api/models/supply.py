...
class Supply(Base, models.Model):
    ...
    liter = models.DecimalField('Litros', max_digits=10, decimal_places=2, blank=False, null=False)
    price = models.DecimalField('Preço', max_digits=10, decimal_places=2, blank=False, null=False)
    kilometer = models.DecimalField('Kilometragem', default=000.000,  max_digits=7, decimal_places=3, blank=False, null=False)
